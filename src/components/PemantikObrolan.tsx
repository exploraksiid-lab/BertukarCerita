...
interface PemantikObrolanProps {
  phase: string | null;
  setPhase: (phase: string | null) => void;
}

export function PemantikObrolan({ phase, setPhase }: PemantikObrolanProps) {
  ...
  return (
    <>
      <header className="mb-6 text-center w-full relative z-10">
